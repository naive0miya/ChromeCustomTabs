...
import org.youtwo.chromecustomtabs.util.ImageUtils;
import org.youtwo.chromecustomtabs.util.SnackbarFactory;
...
public class MainActivity extends BaseActivity {
  ...
  private CustomTabActivityHelper.ConnectionCallback mConnectionCallback = new CustomTabActivityHelper.ConnectionCallback() {
    ...
    public void onCustomTabsConnected() {
      SnackbarFactory
          .createSnackbar(MainActivity.this, mLayoutMainCoordinator, "Connected to service").show();
    }
